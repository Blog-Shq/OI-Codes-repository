...
#define ll long long
    ...
    inline bool blank(char __Input_Char__) {return __Input_Char__ == ' ' || __Input_Char__ == '\n' || __Input_Char__ == '\r' || __Input_Char__ == '\t';}

    inline void __FastIO_read__(int &x) {
        register bool sign = 0; register char __Input_Char__ = __Fread_Getchar__(); x = 0;
        ...
        for (;__Input_Char__ >= '0' && __Input_Char__ <= '9'; __Input_Char__ = __Fread_Getchar__()) x = x * 10 + __Input_Char__ - '0';
        sign && (x = -x);
    }
    ...
    inline ll SlowRead () {
        register char __Input_Char__ = 0; register ll __Input_Data__ = 0, __Data_Symbol__ = 1;
        while (__Input_Char__ != '-' and (__Input_Char__ < '0' || __Input_Char__ > '9')) __Input_Char__ = getchar();
